...
public class SQLCustomerService(IConfiguration configuration) : SQLDAL(configuration)
{
    public IEnumerable<CustomerServiceTicket> GetAllCustomerServiceTickets()
    {
        ...
        try
        {
            ...
            connection.Query<CustomerServiceTicket, Customer, ContactDescription, CustomerServiceTicket>(
                sql,
